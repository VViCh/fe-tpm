...
const AboutSection = () => {
  return (
    <div className={styles.container}>
     ...
     <div className= {styles.lensa}> <img src="./lensa.png" alt="lensa" />  </div> 
      ...
      <div className={styles.card}>
        ...
        <button className={styles.button}>Guidebook</button>
        <div className= {styles.rocket}> <img src="./rocket.png" alt="rocket" /> </div>
      </div>
    </div>
  );
};
